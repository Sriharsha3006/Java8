...
public class PersonData {
	...
	public ArrayList<Person> getPersonList(){
		...
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 27, 2700);
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 27, 2000);
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 27, 2300);
		personList.add(p);
		
		p = new Person("Sriharsha", "Bopparaju", 27, 2500);
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 22, 2500);
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 28, 2500);
		personList.add(p);
		p = new Person("Sriharsha", "Bopparaju", 17, 2500);
		personList.add(p);
